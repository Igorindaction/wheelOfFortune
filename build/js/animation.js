...
window.onload = function () {
  ...
  var rotatingWrapper = document.querySelector('.arrow-wrapper');
  var popUp = document.querySelector('.pop-up');
  var popUpCrossSvg = document.querySelector('.pop-up-cross-icon');
  var popUpText = document.querySelector('.pop-up-text');
  var wheelArrow = document.querySelector('.wheel-arrow');
  var button = document.getElementById('startSpin');
  var fifty = 50;
  var twenty = 20;
  ...
  button.addEventListener('click', function () {
    var getRandomNumbers = getRandomInt(0, 360);
    $.keyframe.define({
      name: 'moving_wrapper',
      '0%': {
